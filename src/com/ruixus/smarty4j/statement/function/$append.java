...
/**
 * This is used for creating or appending template variable arrays during the execution of a
 * template.
 * 
 * <table border="1">
 ...
 * <td align="center"><span class="emphasis"><em>n/a</em></span></td>
 * <td>The index for the new array element. If not specified the value is append to the end of the
 * array.</td>
 * </tr>
 * </tbody>
 * </table>
...
public class $append extends LineFunction {
	...
	private static final Definition[] definitions = {
	    ...
	    Definition.forFunction("index", Type.STROBJ) };
