 ...
 * 方法，第一个参数是需要被调节的变量，第二个参数是变量调节器的参数组， 如果不希望进行jvm字节码开发，开发人员应该继承自这个类来实现自己的变量调节器扩展节点。
 * 
 * @see com.ruixus.smarty4j.Template#addModifier(IModifier)
 * 
...
public abstract class Modifier extends Parameter {
	 ...
	 *           参数不合法
	 * @see com.ruixus.smarty4j.Template#addNode
	 */
	public void createParameters(Template tpl, List<Expression> values) throws ParseException {
		...
		try {
			this.getClass().getDeclaredMethod("parse", MethodVisitorProxy.class, int.class,
			    VariableManager.class);
		} catch (Exception e) {
			this.index = tpl.addNode(this);
		}
	}
	...
	public void parse(MethodVisitorProxy mv, int local, VariableManager vm) {
		...
		mv.visitMethodInsn(INVOKEVIRTUAL, className, "execute", "(Ljava/lang/Object;"
		    + getDesc() + ")Ljava/lang/Object;");
	}
}