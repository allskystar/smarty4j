...
import com.ruixus.smarty4j.expression.ListExpression;
import com.ruixus.smarty4j.expression.ListExtended;
import com.ruixus.smarty4j.expression.MapExpression;
import com.ruixus.smarty4j.expression.MapExtended;
import com.ruixus.smarty4j.expression.MixedStringExpression;
import com.ruixus.smarty4j.expression.ModifierExtended;
import com.ruixus.smarty4j.expression.NullExpression;
import com.ruixus.smarty4j.expression.ObjectAdapter;
import com.ruixus.smarty4j.expression.ObjectExpression;
import com.ruixus.smarty4j.expression.PropertyExpression;
...
public class Analyzer {
	 ...
	 *          variable's name
	 * @param className
	 *          the classname to be associated with the specified variable's name
	 */
	...
	/**
	 * Binding property, make the specified variables can support the var@key syntax, see
	 * {@link com.ruixus.smarty4j.statement.function.$foreach}.
	 * 
	 * @param varName
	 *          variable's name
	 * @param clazz
	 ...
	 * @return the list will store all token of the statement, but the last 2 elements are the start
	 *         index and the end index of the statement match, {@code null} if the line no contains a
	 *         smarty statement
	 * @throws ParseException
	 *           If the statement's syntax is invalid
	 */
	public SimpleStack lexical(String line) throws ParseException {
		...
		lexical: while (true) {
			...
			if (pos > rIndex) {
				// the right delimiter between two quotes, it is part of string, this will find new right
				// delimiter
	...
	private Expression findNumber(String line) throws ParseException {
		...
		return isFloat ? new ConstDouble(Double.parseDouble(token)) : new ConstInteger(
