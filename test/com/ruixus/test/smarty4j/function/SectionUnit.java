...
public class SectionUnit extends BaseUnit {
	...
	public void basic() throws Exception {
		Assert
		    .assertEquals(
		        "section",
		        getString("{assign var=\"animals\" value=[Rat,Ox,Tiger,Hare,Dragon,Serpent,Horse,Sheep,Monkey,Rooster,Dog,Boar]}{section loop=$animals name=\"item\" start=5 step=-2 max=2}{$item}\n{/section}"),
		        "5\n3\n");
		Assert
    .assertEquals(
        "section",
